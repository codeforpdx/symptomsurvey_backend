...
class TweetGrab:
    ...
    tweet_info = {'timestamp': timestamp, 'city_coordinates':city_coordinates,'user_coordinates':user_coordinates,'stated_coordinates':stated_coordinates,'bounding_coordinates':bounding_coordinates,} 
